    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '14. Attention 反向传播推导', link: '/02_PyTorch_Algorithms/14_Attention_Backward_Math' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '13. Triton Memory Model and Debug', link: '/03_CUDA_and_Triton_Kernels/13_Triton_Memory_Model_and_Debug' },
          { text: '15. Triton Llama3 Block Project', link: '/03_CUDA_and_Triton_Kernels/15_Triton_Llama3_Block_Project' },
          { text: '16. Triton Best Practices and FAQ', link: '/03_CUDA_and_Triton_Kernels/16_Triton_Best_Practices_and_FAQ' },
          { text: '17. PyTorch CUDA Streams and Transfer', link: '/03_CUDA_and_Triton_Kernels/17_PyTorch_CUDA_Streams_and_Transfer' },
          { text: '20. Distributed Communication Primitives', link: '/03_CUDA_and_Triton_Kernels/20_Distributed_Communication_Primitives' },
          { text: '21. DeepSpeed Zero Config', link: '/03_CUDA_and_Triton_Kernels/21_DeepSpeed_Zero_Config' },
          { text: '22. CUDA Custom Kernel Intro', link: '/03_CUDA_and_Triton_Kernels/22_CUDA_Custom_Kernel_Intro' },
          { text: '23. CUDA Shared Memory Optimization', link: '/03_CUDA_and_Triton_Kernels/23_CUDA_Shared_Memory_Optimization' },
